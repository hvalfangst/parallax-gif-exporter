...
pub fn start_event_loop(mut game_state: State, core_logic_map: HashMap<String, Rc<RefCell<dyn CoreLogic>>>, experimental: bool) {
    let mut x_offset = 0;
    ...
    println!("Starting GIF encoding in {} mode with dimensions: {}x{}", encoding_mode, width, height);
